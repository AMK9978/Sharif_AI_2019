...
//        }
    ...
    private void finding_good_cell_to_move(Hero[] My_heroes, World world) {
        ...
        for (Hero hero : My_heroes) {
            ...
            if (world.getMap().isInMap(cell.getRow() - 1, cell.getColumn()) &&
                ...
                score = getCellScore(hero, world, targetCell, Healer, isHealer);
                if (max < score) {
                    max = score;
    ...
    private double getCellScore(Hero hero, World world, Cell targetCell, Hero Healer, Boolean isHealer) {
        double score = 0;
        ...
        for (Hero oppHero : oppHeroes) {
            ...
            if (oppHero.getName().equals(HeroName.SENTRY) && world.isInVision(hero.getCurrentCell()
                    , oppHero.getCurrentCell())) {
                score -= 1;
